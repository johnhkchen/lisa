...
///
/// Keep this byte-for-byte stable across generated project context, the
/// workflow document's preamble, and ticket assignments. Consumers should interpolate this constant
...
- **Working a ticket for Lisa?** You were started by `lisa loop`: your prompt names one ticket and its phase, and `LISA_TICKET_ID` is set in your environment. Take that one ticket through implementation and review, leave a reviewable record, and wait for Lisa to confirm completion.\n\
